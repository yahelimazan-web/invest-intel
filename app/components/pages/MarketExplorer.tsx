...
export default function MarketExplorer() {
  ...
  const intelligenceData = analysisData ? {
    ...
    market: {
      ...
      latestSaleDate: null,
      avgSoldPrice: analysisData.prices.averageByYear[analysisData.prices.averageByYear.length - 1]?.avgPrice ?? null,
    ...
    dataQuality: {
      ...
      crime: !!analysisData.crime.isLiveData,
      prices: !!analysisData.prices.isLiveData,
      proximity: !!analysisData.proximity?.trainStation,
    },
