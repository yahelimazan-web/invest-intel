...
const VERIFIED_NEWS_SOURCES: NewsItem[] = [
  {
    ...
    summary:
      "The Monetary Policy Committee voted to reduce the Bank Rate to 3.75%, citing improving inflation outlook and the need to support economic growth. This is the lowest rate since early 2023.",
  ...
  },
  {
    ...
    summary:
      "The UK House Price Index shows average house prices in the UK increased by 3.3% in the 12 months to November 2025. The average UK house price was £268,000 in November 2025.",
    source: "HM Land Registry",
    sourceUrl:
      "https://www.gov.uk/government/statistics/uk-house-price-index-for-november-2024",
  ...
  },
  {
    ...
    summary:
      "National asking prices rise by 1.7% this month to £366,189. Buyer demand up 9% compared to this time last year.",
    source: "Rightmove",
  ...
  },
  {
    ...
    summary:
      "Average UK rents reach record high of £1,327pcm. Rental growth slowing but still outpacing wage growth in most regions.",
    source: "Zoopla",
    sourceUrl:
  ...
  },
  {
    ...
    summary:
      "New buyer enquiries and agreed sales both picked up over the month. Price expectations remain modestly positive over the near term.",
    source: "Royal Institution of Chartered Surveyors",
    sourceUrl:
      "https://www.rics.org/news-insights/research-and-insights/uk-residential-market-survey",
  ...
  },
  {
    ...
    summary:
      "Annual house price growth stands at 3.3% in December. Average house price now £297,166. Northern Ireland and Scotland lead regional growth.",
    source: "Halifax",
  ...
  },
  {
    ...
    summary:
      "UK house prices rose 0.7% month-on-month in December. Annual growth rate at 4.7%. First-time buyers remain active despite affordability pressures.",
  ...
  },
  {
    ...
    summary:
      "The Consumer Prices Index (CPI) rose by 2.5% in the 12 months to December 2024. Housing and household services made the largest contribution to the annual rate.",
  ...
  },
  {
    ...
    summary:
      "The UK housing market shows signs of recovery as mortgage rates stabilize and buyer confidence returns.",
    source: "BBC News",
  ...
  },
  {
    ...
    summary:
      "Changes to capital gains tax and EPC requirements are reshaping the private rental sector investment landscape.",
  ...
  },
  {
    ...
    summary:
      "Estate agents report strongest start to year since 2022, with particular strength in sub-£500k market.",
  ...
  },
  {
    ...
    summary:
      "Build-to-rent sector sees £2.3bn investment in Q4 2025, signaling renewed confidence in UK housing market.",
...
const VERIFIED_ANALYST_REPORTS: AnalystReport[] = [
  {
    ...
    summary:
      "Prices expected to rise 3-4% in 2026. Regional divergence continues with North outperforming South. Rental market remains tight.",
    rating: "bullish",
    targetRegion: "UK",
    priceTarget: "+3.5% YoY",
    sourceUrl:
      "https://www.rics.org/news-insights/research-and-insights/market-outlook",
  ...
  },
  {
    ...
    summary:
      "Mainstream house prices to grow 23.4% over five years to 2029. Prime central London expected to outperform.",
    rating: "bullish",
    targetRegion: "UK",
  ...
  },
  {
    ...
    summary:
      "Liverpool and Manchester remain top picks for yield-focused investors. Regeneration projects driving 8-10% rental growth.",
    rating: "bullish",
    targetRegion: "North West",
    priceTarget: "+5.5% YoY",
    sourceUrl:
      "https://www.knightfrank.co.uk/research/uk-residential-market-outlook",
  ...
  },
  {
    ...
    summary:
      "Institutional capital flowing into regional cities. Birmingham, Leeds, and Manchester lead deal volume.",
    rating: "bullish",
    targetRegion: "Regional Cities",
    priceTarget: "6.2% net yield",
    sourceUrl:
      "https://www.jll.co.uk/en/trends-and-insights/research/build-to-rent-report",
  ...
  },
  {
    ...
    summary:
      "Prime London showing early signs of recovery. International buyer interest increasing. Prices 15% below 2014 peak in real terms.",
    rating: "neutral",
    targetRegion: "London",
    priceTarget: "+2.0% 2026",
    sourceUrl:
      "https://www.cbre.co.uk/insights/reports/london-residential-market-view",
  ...
  },
  {
    ...
    summary:
      "First-time buyers driving activity. Mortgage availability improving. Supply constraints persist in popular areas.",
    rating: "bullish",
    targetRegion: "UK",
...
async function fetchExternalNews(
  ...
  try {
    ...
    console.log(
      `[News] Fetched ${articles.length} articles from last 24 hours`,
    );
    return articles;
  } catch (error) {
  ...
  try {
    ...
    if (cachedNews && Date.now() - cachedNews.timestamp < CACHE_DURATION) {
      ...
      return NextResponse.json({
        ...
        disclaimer:
          "All news items include links to original sources for verification.",
      });
    }
    ...
    console.log(
      "[NewsAPI] External articles from last 24 hours:",
      externalNews.length,
    );
    console.log("[Analysts] Reports:", VERIFIED_ANALYST_REPORTS.length);
    if (externalNews.length > 0) {
      console.log(
        "[NewsAPI] Latest headline:",
        externalNews[0]?.title?.substring(0, 60) + "...",
      );
    ...
    const allNews = externalNews.sort(
      (a, b) =>
